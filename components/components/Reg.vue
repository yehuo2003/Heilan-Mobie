...
.app_reg .mui-card-footer {
  border-top: 1px dashed #aaa;
}
.app_reg .mui-card-footer ul {
  padding-left: 5px;
  display: flex;
}
.app_reg .mui-card-footer ul li {
  padding-left: 15px;
  margin: auto;
  width: 110px;
  list-style: none;
}
.app_reg .mui-input-group .mui-button-row {
  height: 35px;
  padding-top: 7px;
}
.app_reg .mui-card-footer ul li:nth-child(1) {
  border-right: 1px solid #aaa;
  padding-left: 20px;
}
.app_reg .mui-card-footer ul li:nth-child(1) img {
  width: 50px;
}
.app_reg .mui-card-footer ul li:nth-child(2) {
  border-right: 1px solid #aaa;
  padding-left: 30px;
}
.app_reg .mui-card-footer ul li:nth-child(2) img {
  margin-left: 10px;
  width: 30px;
}
.app_reg .mui-card-footer ul li:nth-child(3) img {
  margin-left: 20px;
  width: 28px;
}
</style>
